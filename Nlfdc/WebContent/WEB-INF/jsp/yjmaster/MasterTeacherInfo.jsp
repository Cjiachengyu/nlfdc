...
<div class="bg_white simple_shadow">
	<div class="wrap">
        <a class="sub_menu_button " href="yjmasterteacheraction?checkType=1" >按班级查看</a>
        <a class="sub_menu_button font_bold bg_light_gray highlight" >按老师查看</a>
		<div class="clear"></div>
	</div>
</div>
...
<div class="wrap">
	...
	<div id="content" class="clearfix">
		...
		<div class="main_content" id="main_content">
			<%@ include file="TeacherListView.jsp"%>
		</div>
		<div class="clear"></div>
	</div>
</div>

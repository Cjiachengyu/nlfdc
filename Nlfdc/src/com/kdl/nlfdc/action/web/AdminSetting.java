...
@SessionScope
@UrlBinding("/adminsettingaction")
public class AdminSetting extends AbstractUserSetting
{
    private static final long serialVersionUID = 3197153244985380409L;
    
    private static final String EDIT_PWD = "/WEB-INF/jsp/admin/AdminSettingPwd.jsp";

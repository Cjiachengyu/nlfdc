...
@SessionScope
@UrlBinding("/yjteachermobilenotification")
public class YjTeacherMobileNotification extends AbstractNotification
{
    
    
    private static final String MAIN_PAGE = "/WEB-INF/jsp/yjteacher/MobileYjTeacherNotification.jsp";
